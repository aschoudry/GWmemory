...
Spin_vec = [0.60, 0.95]
filename_vec=['m0p60', 'm0p94']
tf_vec=[-600.0, -600.0]
ti_vec=[-16000,  -6000]
idx_cut_vec = [200, 200, 200]
line_thickness_vec = [3,3]
line_style = [":", "-."]
...
Spin_vec = [0.60, 0.80, 0.99]
filename_vec=[ '0p60', '0p80','0p99']
tf_vec=[-10, -10, -10.0]
ti_vec=[-9000, -9000, -9000]
idx_cut_vec = [80, 80, 80, 80]
...
plt.legend(loc=2)
fontP.set_size('12.')
plt.savefig('/home/ashok/Desktop/IPTA slides/MemeoryAll.pdf')
plt.show()
