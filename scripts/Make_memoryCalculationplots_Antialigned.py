...
#import data
mass_ratio_vec = [0.20, 0.43, 0.60, 0.94]
filename_vec=['m0p20', 'm0p43','m0p60','m0p94']
i=0
...
for filename in filename_vec:
	...
	plt.savefig('/home/ashok/gravitational_wave_memory_project/plots/MemoryPlot_AntialignedSpinSXSdata/'+filename+'.png')
	i+=1
#	plt.show()
	plt.close()
...
Spin_vec = [0.20, 0.60, 0.95]
filename_vec=['m0p20','m0p60', 'm0p94']
tf_vec=[-600.0, -600.0, -600.0]
ti_vec=[-9000, -16000,  -6000]
idx_cut_vec = [200, 200, 200, 200]
line_thickness_vec = [3,3,3]
line_style = [":", "-.",  "-"]
...
#	plt.plot(time_tot, hmem_tot, label=r'$|\chi|$ = '+str(Spin_vec[i]))
...
plt.legend(loc=2)
fontP.set_size('12.')
plt.savefig('/home/ashok/gravitational_wave_memory_project/plots/MemoryPlot_AntialignedSpinSXSdata/'+filename+'.pdf')
plt.show()
