...
#	print Slope_hmem_NR, dhp_mem_PN_dt[idx], len(timeNR)
	...
	ax1.plot(time_tot, hmem_tot, label='q = '+str(mass_ratio_vec[i]),linewidth=line_thickness_vec[i])
...
#	plt.plot(timeNR, hmem + hp_mem_PN_cut[-1], 'y--' )
#	ax2.plot(time_PN_original+552, hp_mem_PN_original, 'r--')
	i+=1
