...
filename='rMPsi4_noSpin_q1dataClean';
save_location='/home/aschoudhary/gravitational_wave_memory_project/data/NonSpinning_differentMassRatio/Memory_data/';
filename_and_loc=strcat(save_location, filename);
wave = load(strcat(strcat('/home/aschoudhary/gravitational_wave_memory_project/data/NonSpinning_differentMassRatio/',filename),'.txt'));
timeNR = wave(:,1);
psi_plus = wave(:,2);
psi_cross = wave(:,3);
