...
y1 = Inegrate(x0, dt, nsteps, eta, M, 1)
y2 = Inegrate(x0, dt, nsteps, eta, M, 2)
y3 = Inegrate(x0, dt, nsteps, eta, M, 2.5)
y4 = Inegrate(x0, dt, nsteps, eta, M, 3)

h1 = h_plus_mem(theta, eta, M, R, x0, dt, nsteps, 1)
h2 = h_plus_mem(theta, eta, M, R, x0, dt, nsteps, 2)
h3 = h_plus_mem(theta, eta, M, R, x0, dt, nsteps, 2.5)
h4 = h_plus_mem(theta, eta, M, R, x0, dt, nsteps, 3)


plt.plot(time_PN ,y1, 'r')
plt.plot(time_PN, y2, 'g')
plt.plot(time_PN, y3, 'b')
plt.plot(time_PN, y4, 'k')

plt.show()

plt.plot(time_PN ,h1, 'r')
plt.plot(time_PN, h2, 'g')
plt.plot(time_PN, h3, 'b')
plt.plot(time_PN, h4, 'k')
